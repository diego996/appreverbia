...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-4 vstack gap-3">
        <div>
            ...
            @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                <div>
                    <p class="small text-secondary mt-2">
                        ...
                        <button wire:click.prevent="sendVerification" class="btn btn-link btn-sm p-0 align-baseline">
